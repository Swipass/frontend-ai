  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
        <div style={{ width: 36, height: 36, borderRadius: '50%', background: C.surface2, border: `1px solid ${C.mid}`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.7rem', color: C.muted }}>◈</div>
        <div>
      ...
      <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.4rem' }}>
        <span style={{ ...displayFont, fontSize: '1.6rem', fontWeight: 700, color: C.max, letterSpacing: '-0.03em' }}>
